        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 ml-20 max-w-[570px] lg:mb-0">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className=" relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12 text-white">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
